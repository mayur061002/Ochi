  ...
  return (
    <div data-scroll data-scroll-section data-scroll-speed="-0.02" className="w-full h-full bg-zinc-100 max-md:h-fit flex max-md:block items-center p-20 rounded-tl-3xl rounded-tr-3xl max-md:px-10">
      <motion.div 
        ...
        className="relative eyy w-1/2 h-full text-[9vw] max-md:text-[12vw] max-md:leading-[8.5vw] leading-[6.5vw]  uppercase font-extrabold text-[#202021] ">
        <h1>Eye-</h1>
        <h1>opening</h1>
        
      </motion.div>
      <div className='absolute mt-[240px] max-md:py-28 '>
        <svg className='mt-96' width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="w-1/2 h-full   text-[#202021] ">
        <div className='eyy'>
          <h1 className="text-[9vw] max-md:text-[12vw] max-md:leading-[8.5vw]  leading-[6vw] uppercase font-extrabold">presentations</h1>
        </div>

        <div className="w-full h-fit flex text-[1.1vw] items-center max-md:items-start max-md:gap-10">
          <div className="w-1/2 max-md:w-full h-fit max-md:text-[3.5vw] ">
            ...
            <h3 className="mt-10 text-[#20202177]">© ochi design 2024. Legal Terms</h3>

          </div>

          <div className="w-1/2 max-md:mt-24 px-20 h-fit max-md:text-[3.5vw]">
            ...
            <h3 className="mt-14 text-[#20202177]">Website By May'sWorld</h3>
          </div>
