  ...
  return (
    <div className="w-full bg-zinc-100 rounded-tl-3xl rounded-tr-3xl  pt-20">
      ...
      <div className=" w-full  mt-5  max-md:px-0 relative  ">
        {Data.map((item, index) => {
          return (
            <div onMouseEnter={() => hoverd(index)} onMouseLeave={() => hoverd("")} className="w-1/2 h-[45vw]  inline-block p-10 max-md:p-5  max-md:mb-5 align-top relative ">
              ...
              <div className={`absolute flex items-center justify-center    w-[90vw] top-[50%]  ${item.id % 2 == 0 ? "left-[-70%]" : "right-[-70%]"} z-[999] pointer-events-none  whitespace-nowrap overflow-hidden  translate-y-[-50%] text-[6vw] font-bold tracking-tighter text-[#ccea69]`} >
                <h1 className="">
