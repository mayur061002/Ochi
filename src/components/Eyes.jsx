    ...
    <div className='eyes w-full h-screen overflow-hidden'>
      <div className='w-full h-full relative bg-cover bg-center bg-[url("https://ochi.design/wp-content/uploads/2022/05/Top-Viewbbcbv-1-scaled.jpg")]'>
        <div className='absolute flex gap-10 top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%] '>
          <div className='w-[13vw] h-[13vw] flex items-center justify-center bg-zinc-50 rounded-full'>
            <div style={{ transform: `translate(${dx}px, ${dy}px` }} className='w-[10vw] h-[10vw] relative bg-black rounded-full'>
